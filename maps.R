...
svg <- c('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 360" preserveAspectRatio="xMinYMin meet" fill="none" stroke="#111" stroke-linecap="round" stroke-linejoin="round">', sprintf('<text x="24" y="50" font-size="36" fill="#111" stroke="none">%s</text>', river), sprintf('<path d="%s" stroke-width="5"/>', d), "</svg>")
