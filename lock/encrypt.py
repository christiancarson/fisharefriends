...
(out / "index.html").write_text(pathlib.Path(__file__).with_name("unlock.html").read_text())
(out / "404.html").write_text(pathlib.Path(__file__).with_name("unlock.html").read_text())
